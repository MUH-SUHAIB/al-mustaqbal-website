...
export type { SectionProps } from "./section-shell";

export { Hero } from "./hero";
export type { HeroContent } from "./hero";

export { About } from "./about";
export type { AboutContent, AboutHighlight } from "./about";
...
export type { ContactContent, WorkingHoursRow } from "./contact";

export { Footer } from "./footer";
export type { FooterContent, FooterLink, FooterSocialLink } from "./footer";
