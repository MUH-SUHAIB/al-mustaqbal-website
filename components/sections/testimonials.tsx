...
function PremiumQuoteIcon({
  ...
  return (
    ...
    >
      <path
        d="M10 11H6a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v3a4 4 0 0 1-4 4M19 11h-4a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v3a4 4 0 0 1-4 4"
        strokeWidth="1.75"
        strokeLinecap="round"
...
export function Testimonials({
  ...
  /* Safety: prevents errors if testimonials is temporarily empty */
  const currentIndex =
  ...
  }, [isHovered, paginate, testimonials.length]);
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div
        className="absolute inset-0 -z-10 bg-[linear-gradient(to_bottom,rgba(255,241,242,0.7)_0%,rgba(239,246,255,0.6)_40%,rgba(219,234,254,0.4)_100%)] dark:bg-[linear-gradient(to_bottom,rgba(225,29,72,0.03)_0%,rgba(29,78,216,0.03)_40%,transparent_100%)]"
        aria-hidden="true"
      />
      ...
      <Section
        ...
        animate={animate}
      >
        {/* Google Verified Aggregate Badge */}
        {aggregateScore && (
          <motion.div
            {...(animate
              ? {
          ...
          >
            <div className="inline-flex items-center gap-3 rounded-full border border-blue-300 bg-white/80 px-5 py-2 shadow-sm backdrop-blur-md transition-all hover:border-blue-400 hover:bg-white hover:shadow-md dark:border-blue-500/50 dark:bg-slate-800/80">
              ...
              <span className="text-sm font-bold tracking-tight text-foreground">
                {aggregateScore.rating.toFixed(1)}
              </span>

              <StarRating
                rating={Math.round(aggregateScore.rating)}
              />

              <span className="h-3.5 w-px bg-slate-300 dark:bg-slate-600" />

              <span className="text-xs font-medium text-muted-foreground">
                {aggregateScore.totalReviews}{" "}
                {aggregateScore.platform}
              </span>
            </div>
          </motion.div>
        )}
        ...
        <div className="relative mx-auto w-full max-w-6xl">
          {/* STABLE HEIGHT TESTIMONIAL CARD */}
          <motion.div
            {...(animate
              ? {
                  variants: slideUp,
          ...
          >
            ...
            <motion.button
              ...
              className="absolute end-3 top-1/2 z-20 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-blue-200 bg-white/90 text-foreground shadow-md backdrop-blur-md sm:end-6 sm:h-12 sm:w-12 dark:border-slate-700 dark:bg-slate-800"
            >
            ...
            <div className="relative flex min-h-0 items-center justify-center px-5 sm:px-12">
              ...
              >
                ...
                >
                  ...
                  <Text
                    variant="body"
                    className="text-foreground/90 text-base font-medium italic leading-relaxed text-balance sm:text-lg md:text-xl md:leading-relaxed"
                    dir="auto"
                  >
                    “{activeReview.review}”
                  </Text>
